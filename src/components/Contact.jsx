              ...
              <div className="bg-dark-800 p-8 rounded-xl border border-dark-700 h-full">
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 rounded-full bg-dark-700 flex items-center justify-center text-white/70 hover:bg-primary-500 hover:text-white transition-all duration-300">
