              ...
              <div className="bg-dark-800 p-8 rounded-xl border border-dark-700 h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-white font-medium mb-1">Kampus</h4>
                      <p className="text-white/70">Universitas Teknologi Digital Indonesia (UTDI)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">Yogyakarta, Indonesia</p>
                    </div>
                  </div>
                </div>
                
                <div className="mt-10">
                  <h4 className="text-white font-medium mb-4">Temukan Saya Di</h4>
                  <div className="flex space-x-4">
                    <a href="https://www.instagram.com/aldiputraa_" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-dark-700 flex items-center justify-center text-white/70 hover:bg-gradient-to-tr from-purple-600 to-pink-500 hover:text-white transition-all duration-300">
                    ...
                    <a href="https://github.com/aldiputraa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-dark-700 flex items-center justify-center text-white/70 hover:bg-gray-800 hover:text-white transition-all duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
